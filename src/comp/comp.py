...
print("===== MINE - name ends between a and e ====")
cc = [human.name for human in humans if "a" <= human.name[-1] <= "e"]
print(cc)
...
print(d)
print(" ====== MINE = Ages plus 10 *2 =====")
dd = [human.age *2 + 100 for human in humans ]
print(dd)
...
# f = [human.age for human in humans if human.age <= 32]
